...
### Fixed
- Annotations submitted while Pi is disconnected are now saved with their screenshots and recovered the next time you run `/annotate`. Thanks to [@drouhard](https://github.com/drouhard) for #26.
...
- Added explicit WSL-to-Windows Browser Host bridge setup. Thanks to muhammadessam for the report.
